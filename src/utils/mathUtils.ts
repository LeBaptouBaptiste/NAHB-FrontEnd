 ...
 */
export const pixelsToPercentage = (rect: Rect, container: Dimensions): Omit<Hotspot, 'targetPageId'> => {
 ...
 */
export const percentageToPixels = (hotspot: Omit<Hotspot, 'targetPageId'>, container: Dimensions): Rect => {
    return {
