	...
	return (
		<div className="bg-gray-800 border border-gray-700 rounded-lg p-6 my-4">
			<div className="text-center">
				...
				<div className="mb-4">
					{rolling && <div className="text-6xl animate-bounce">🎲</div>}

					{result && (
						<div className="space-y-2">
							<div className="text-5xl font-bold text-white">{result.roll}</div>
							<div className="text-sm text-gray-400">
								{result.roll} (dé) {bonus >= 0 ? "+" : ""}
								{bonus} ({bonusLabel}) ={" "}
