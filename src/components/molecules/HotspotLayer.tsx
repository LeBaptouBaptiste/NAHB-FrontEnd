...
export function HotspotLayer({ imageUrl, hotspots, onHotspotClick, showDebug = false }: HotspotLayerProps) {
        ...
        <div className="relative w-full h-full select-none">
            ...
            {hotspots.map((hotspot, index) => (
                <div
                    ...
                    className={`absolute cursor - pointer transition - all duration - 200 ${showDebug
