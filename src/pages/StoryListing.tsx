		...
		await Promise.all(
			storyList.map(async (story) => {
				try {
					...
					console.error(
						`Failed to load ratings for story ${story._id}:`,
						error
					);
					...
					<div className="flex gap-4">
						...
						<DropdownMenu>
							<DropdownMenuTrigger asChild>
								<Button
									variant="outline"
									className="gap-2 hover:bg-emerald-50 hover:text-emerald-700 hover:border-emerald-500 dark:hover:bg-emerald-950/20 transition-colors cursor-pointer"
								>
