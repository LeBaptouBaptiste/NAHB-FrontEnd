    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <Card className="w-full max-w-md mx-4 relative z-10 bg-card/60 backdrop-blur-md border-white/10 shadow-2xl">
        <CardHeader className="text-center space-y-4">
          ...
          <div>
            <CardTitle className="text-2xl font-bold text-gradient">Welcome to NAHB</CardTitle>
        ...
        <form onSubmit={handleLogin}>
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between text-sm">
              <Link to="/forgot-password" className="text-emerald-500 hover:text-emerald-400 transition-colors hover:underline">
                Forgot password?
              </Link>
            </div>
          </CardContent>
          ...
          <CardFooter className="flex flex-col gap-4">
            ...
            <div className="text-sm text-center text-muted-foreground">
              ...
              <Link to="/register" className="text-emerald-500 hover:text-emerald-400 transition-colors hover:underline font-medium">
                Register
              </Link>
            </div>
          </CardFooter>
