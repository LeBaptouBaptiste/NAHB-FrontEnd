...
export function EndOfStory() {
  ...
  const { ending, path } = location.state || { ending: "Unknown Ending", path: [] };

  const endingStats = {
    "Heroic Victory": { percentage: 32, color: "from-yellow-500 to-yellow-600" },
    "Dark Alliance": { percentage: 18, color: "from-purple-500 to-purple-600" },
    "Peaceful Resolution": { percentage: 25, color: "from-blue-500 to-blue-600" },
  ...
  const currentEndingStats = endingStats[ending as keyof typeof endingStats] || { percentage: 0, color: "from-primary to-secondary" };
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="p-4 bg-gradient-to-r from-primary/10 to-secondary/10 rounded-lg border border-primary/30">
                <div className="text-sm text-muted-foreground mb-1">Achievement Unlocked</div>
