															...
															<div className="space-y-3 pl-6 bg-emerald-500/5 p-3 rounded-lg border border-emerald-500/20">
																<div className="grid grid-cols-2 gap-3">
																	...
																	<div className="space-y-2">
																		...
																		<Select
																			value={
																				choice.diceRoll?.successPageId || "none"
																			}
																			onValueChange={(value) => {
																				const currentDiceRoll =
																					choice.diceRoll || {
																		...
																		>
																			...
																			<SelectContent>
																				<SelectItem value="none">
																					None (Use Target Page)
																				</SelectItem>
																				{pages
																					.filter(
																						(p) => p._id !== selectedPage._id
																					)
																					.map((page) => (
																						<SelectItem
																							key={page._id}
																	...
																	<div className="space-y-2">
																		<Label
																			htmlFor={`failure-page-${index}`}
																			className="text-sm"
																		>
																			Failure Page (Optional)
																		</Label>
																		<Select
																			value={
																				choice.diceRoll?.failurePageId || "none"
																			}
																			onValueChange={(value) => {
																				const currentDiceRoll =
																					choice.diceRoll || {
